...
// Store current URL hash.
	...
	/* Tabs ------------------------------------------------------------------------------------------------------------ */
	$(".tabs__list:not([data-tabs-handler='false'])").attr("role", "tablist")                    // ul
...
// if no selected => select first
	...
	/* Events ---------------------------------------------------------------------------------------------------------- */
	/* click on a tab link */
	$("body").on("click", ".tabs__list:not([data-tabs-handler='false']) .tabs__link", function (event) {
		var $this = $(this),
		...
		$parent.trigger("tabChanged", event);
